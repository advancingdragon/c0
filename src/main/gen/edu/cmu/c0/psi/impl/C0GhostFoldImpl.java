...
public class C0GhostFoldImpl extends ASTWrapperPsiElement implements C0GhostFold {

  public C0GhostFoldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitGhostFold(this);
  }
