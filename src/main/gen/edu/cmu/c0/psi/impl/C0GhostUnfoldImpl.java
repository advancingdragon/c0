...
public class C0GhostUnfoldImpl extends ASTWrapperPsiElement implements C0GhostUnfold {

  public C0GhostUnfoldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitGhostUnfold(this);
  }
