...
public class C0StmtWhileImpl extends ASTWrapperPsiElement implements C0StmtWhile {

  public C0StmtWhileImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public C0StmtExpr getStmtExpr() {
    return findChildByClass(C0StmtExpr.class);
  }
  ...
  @Override
  @Nullable
  public C0StmtVar getStmtVar() {
    return findChildByClass(C0StmtVar.class);
  }
