...
public class C0SpecEnsuresImpl extends ASTWrapperPsiElement implements C0SpecEnsures {

  public C0SpecEnsuresImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitSpecEnsures(this);
  }
