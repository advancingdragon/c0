...
public class C0GhostAssertImpl extends ASTWrapperPsiElement implements C0GhostAssert {

  public C0GhostAssertImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitGhostAssert(this);
  }
