...
public class C0ExprBitwiseNotImpl extends C0ExprImpl implements C0ExprBitwiseNot {

  public C0ExprBitwiseNotImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitExprBitwiseNot(this);
  }
