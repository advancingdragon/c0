...
public class C0ExprUnfoldingImpl extends C0ExprImpl implements C0ExprUnfolding {

  public C0ExprUnfoldingImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitExprUnfolding(this);
  }
