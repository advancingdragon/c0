...
public class C0ExprLogicalNotImpl extends C0ExprImpl implements C0ExprLogicalNot {

  public C0ExprLogicalNotImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitExprLogicalNot(this);
  }
