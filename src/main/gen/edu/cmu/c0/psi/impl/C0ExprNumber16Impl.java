...
public class C0ExprNumber16Impl extends C0ExprImpl implements C0ExprNumber16 {

  public C0ExprNumber16Impl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitExprNumber16(this);
  }
