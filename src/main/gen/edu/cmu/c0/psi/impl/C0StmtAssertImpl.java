...
public class C0StmtAssertImpl extends ASTWrapperPsiElement implements C0StmtAssert {

  public C0StmtAssertImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C0Visitor visitor) {
    visitor.visitStmtAssert(this);
  }
